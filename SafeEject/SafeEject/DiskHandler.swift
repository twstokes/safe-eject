...
class DiskHandler {
    ...
    func registerVolumeMounted(_ callBack: @escaping DADiskDescriptionChangedCallback) -> Void {
        DARegisterDiskDescriptionChangedCallback(daSession, matches, nil, callBack, nil)
    }
    
    func registerDiskDisappeared(_ callBack: @escaping DADiskDisappearedCallback) -> Void {
